    ...
    <div class="w-full md:fixed md:right-0 md:top-0 md:h-full md:w-1/2 bg-primary-400 flex items-center justify-center max-h-screen">
        <div class="w-full max-w-sm p-8 rounded-2xl shadow ring-1 ring-secondary-200 bg-secondary-200">
            ...
            <form action="#" method="POST" class="space-y-6">
                ...
                <div class="relative w-full">
                    <input
                        ...
                        class="w-full rounded-md border px-4 py-3 text-secondary-100 font-bold pr-12"
                    />
                    <span
                ...
                <button type="submit" class="w-full py-3 bg-primary-400 text-white font-bold rounded-md">Daftar</button>
            ...
            <p class="text-center text-sm mt-4 text-primary-200">
                Tidak punya akun? <a href="login" class="text-primary-100 font-bold">Daftar</a>
            </p>
        </div>
    </div>>
</div>
